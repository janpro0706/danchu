...
public class RestaurantController {
	 ...
	 */
	@ResponseBody
	@RequestMapping(value="/{restaurant_name}", method = RequestMethod.DELETE, consumes = "application/json")
	public ResultView delete(HttpServletRequest req, HttpServletResponse res, 
			@PathVariable("restaurant_name") String name) { 
		int result = restaurantService.deleteRestaurant(name);
		if(result < 0) {
